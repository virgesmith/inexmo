        ...
        function_defs = "\n".join(
            sorted(
                _function_template.format(
                    function_name=f.qualified_cpp_name(), function_body=f.body, arg_defs=f.arg_annotations
                )
...
_function_template = """
  m.def("{function_name}", {function_body}, "Generated by inexmod" {arg_defs});
...
def compile(
    *,
    ...
    def register_function(func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        function_spec = FunctionSpec(name=func.__name__, body=function_body, arg_annotations=arg_defs, scope=scope)
